...
import net.minecraft.block.Blocks;
import net.minecraft.block.LilyPadBlock;
import net.minecraft.class_5459.class_5460;
...
//
//    public HelicopterEntity(World world, double x, double y, double z) {
...
//    }
    ...
    public boolean collidesWith(Entity other) {
        return collidesWith(this, other);
    }

    public static boolean collidesWith(Entity entity, Entity entity2) {
...
//            return true;
//        }
        return false;   // TODO for now, helicopters are invulnerable to damage
    }
...
//    }
    ...
    public void pushAwayFrom(Entity entity) {
        // TODO what do we want to do here (currently as BoatEntity)
...
//        if (this.location != net.minecraft.entity.vehicle.BoatEntity.Location.UNDER_WATER && this.location != net.minecraft.entity.vehicle.BoatEntity.Location.UNDER_FLOWING_WATER) {
...
//            }
            ...
            if (this.world.isClient) {
//                this.updatePaddles();
                // TODO do we need to send something to server for movement?
...
//        }
    ...
    private HelicopterEntity.Location checkLocation() {
        HelicopterEntity.Location location = null;//this.getUnderWaterLocation();
        if (location != null) {
    ...
    // TODO don't know what this is: called by updateVelocity
    // it returns something to do with height
    ...
    // above zero implies on land (called from checkLocation())
    // probably a "whole object" version of "is on land"
    ...
    // TODO this might be useful for bounding / collision detection
//    @Nullable
//    private net.minecraft.entity.vehicle.BoatEntity.Location getUnderWaterLocation() {
//        Box box = this.getBoundingBox();
...
//                            return net.minecraft.entity.vehicle.BoatEntity.Location.UNDER_FLOWING_WATER;
//                        }
//
//                        bl = true;
//                    }
...
//        }
//
//        return bl ? net.minecraft.entity.vehicle.BoatEntity.Location.UNDER_WATER : null;
//    }
...
//        double d = -0.04D;
        ...
        if (this.lastLocation == HelicopterEntity.Location.IN_AIR
                && this.location != HelicopterEntity.Location.IN_AIR
                && this.location != HelicopterEntity.Location.ON_LAND) {
    ...
    public void updatePassengerPosition(Entity passenger) {
        if (this.hasPassenger(passenger)) {
            float f = 0.0F;
            float g = (float)((this.removed ? 0.01D : this.getMountedHeightOffset()) + passenger.getHeightOffset());
    ...
    public Vec3d updatePassengerForDismount(LivingEntity passenger) {
        ...
        if (!this.world.isWater(blockPos2)) {
            ...
            UnmodifiableIterator it = passenger.getPoses().iterator();
...
//            this.setBoatType(net.minecraft.entity.vehicle.BoatEntity.Type.getType(tag.getString("Type")));
//        }
    }
    ...
    // change this: helicopters will fly :-)
                ...
                if (this.fallDistance > 3.0F) {
                    ...
                    if (!this.world.isClient && !this.removed) {
                        ...
                        if (this.world.getGameRules().getBoolean(GameRules.DO_ENTITY_DROPS)) {
                            int j;
                            for(j = 0; j < 3; ++j) {
                                // TODO what do we drop if we break?
...
//    public void setBoatType(net.minecraft.entity.vehicle.BoatEntity.Type type) {
//        this.dataTracker.set(BOAT_TYPE, type.ordinal());
//    }
//
//    public net.minecraft.entity.vehicle.BoatEntity.Type getBoatType() {
//        return net.minecraft.entity.vehicle.BoatEntity.Type.getType((Integer)this.dataTracker.get(BOAT_TYPE));
//    }
    ...
    public boolean isSubmergedInWater() {
        return this.location == HelicopterEntity.Location.UNDER_WATER
                || this.location == HelicopterEntity.Location.UNDER_FLOWING_WATER;
    }
...
//        }
//
//        public static net.minecraft.entity.vehicle.BoatEntity.Type getType(int i) {
//            net.minecraft.entity.vehicle.BoatEntity.Type[] types = values();
...
//        }
//
//        public static net.minecraft.entity.vehicle.BoatEntity.Type getType(String string) {
//            net.minecraft.entity.vehicle.BoatEntity.Type[] types = values();
//
