...
public class HelicopterMissileEntity extends FireworkRocketEntity implements FlyingItemEntity {
    ...
    public HelicopterMissileEntity(EntityType<? extends HelicopterMissileEntity> entityType, World world) {
