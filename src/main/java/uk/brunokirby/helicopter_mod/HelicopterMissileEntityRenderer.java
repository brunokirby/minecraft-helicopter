...
public class HelicopterMissileEntityRenderer extends EntityRenderer<HelicopterMissileEntity> {
    protected final HelicopterMissileEntityModel model = new HelicopterMissileEntityModel();

    public HelicopterMissileEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
        super(entityRenderDispatcher);
        this.shadowRadius = 0.8F;
    }

    public void render(HelicopterMissileEntity helicopterMissileEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(HelicopterMissileEntity entity) {
